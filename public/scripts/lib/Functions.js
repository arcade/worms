...
/*
var createClass = function(name, prototype) {
	if(typeof name == 'undefined') {
		throw new Error('You must specify a name for your class.');
	}

	window[name] = (function(prototype) {
		console.log(this)
//		console.log(prototype)
	...
	*/
/*window[name].inherits = function(class) {
		if(!(class instanceof Function)) {
			throw new Error('The provided argument is not a class.');
		}
		...
		for(property in class.prototype) {
			if(typeof window[name].prototype[property] != 'undefined') {
				continue;
			}

			window[name].prototype[property] = class.prototype[property];
		}

		window[name].extends = undefined;
	}*//*
